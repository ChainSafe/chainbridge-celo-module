...
func NewCeloTransaction(chainId *big.Int, nonce uint64, to *common.Address, amount *big.Int, gasLimit uint64, gasPricer evmtypes.GasPricer, data []byte) (evmtypes.CommonTransaction, error) {
